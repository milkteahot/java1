...
public class TeamFight2 {

	public static void main(String[] args) throws InterruptedException {

		Gun[] guns = { new Gun(), new Gun() };
		Sword[] swords = { new Sword(), new Sword() };
		Grenade[] grenades = { new Grenade(), new Grenade() };
		Player[] humanTeam = { new Hunter("총쓰는 헌터", guns), new Hunter("칼쓰는 헌터", swords), new Hunter("수류탄쓰는 헌터", grenades) };
		Player[] nonHumanTeam = { new Goblin("김신"), new Vampire("벨라"), new Vampire("에드워드") };

		// 플레이어 어레이 리스트 만들기
		ArrayList<Player> team1 = new ArrayList<Player>();
		ArrayList<Player> team2 = new ArrayList<Player>();
		setPlayerList(team1, humanTeam);
		setPlayerList(team2, nonHumanTeam);
